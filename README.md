...
The application demonstrates how to build a **native iOS application** using **Swift & SwiftUI**, while applying proven architectural patterns such as **MVVM**, **ViewModel-driven navigation**, **Domain-Driven Design (DDD)**, and **Dependency Injection (DI)**.
